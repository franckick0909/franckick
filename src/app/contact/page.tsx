...
export default function Contact() {
  ...
  const sendEmail = (e: any) => {
    ...
    emailjs
      .sendForm('service_roc1q0g', 'template_5rslfx1', form.current, 'XgNJATb3Y7ca6KHnt')
      .then(
        (result: any) => {
          setSuccess(true);
          form.current?.reset();
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <div className="bg-white dark:bg-slate-950 p-2 lg:p-4 xl:p-6 shadow-lg rounded-lg">
              <div className="flex flex-col gap-2 items-start justify-center mb-8">
                ...
                <span className="text-black dark:text-white text-xs"> Champs obligatoires, ces informations sont nécessaires pour procéder au traitement de votre demande.</span></p>
              </div>
              <div>
                <form className="grid gap-4" ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="w-full grid gap-2 ">
                      ...
                      <div className="grid gap-1">
                        <input
                          ...
                          className="block w-full border-b-[1px] border-slate-950 dark:border-white/50 py-1.5 text-gray-900 dark:text-white outline-none  bg-transparent placeholder:text-gray-400 sm:text-sm sm:leading-6 px-2 placeholder:"
                        />
                        {formData.first_name === "" && (
                  ...
                  <div className="grid gap-1">
                    ...
                    <input
                      ...
                      className="block w-full border-b-[1px] border-slate-950 dark:border-white/50 py-1.5 text-gray-900 outline-none  bg-transparent placeholder:text-gray-400 sm:text-sm sm:leading-6 px-2"
                    />
                    {formData.user_email === "" && (
                      <p className="text-red-500 text-xs">L&apos;email est obligatoire</p>
                    )}
                  </div>
